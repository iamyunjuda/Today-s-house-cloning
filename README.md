...
│   ├── app              				# 앱에 대한 코드 작성
│ 	│   ├── User            			# User 도메인 폴더
│   │ 	│   ├── shopDao.js          	# User 관련 데이터베이스
│ 	│ 	│   ├── shopController.js 		# req, res 처리
│ 	│ 	│   ├── shopProvider.js   		# R에 해당하는 서버 로직 처리
│ 	│ 	│   ├── shopService.js   		# CUD에 해당하는 서버 로직 처리   
...
3. shopRoute.js, shopController.js, shopProvider.js, userDao.js를 구성하여 해당 테이블의 값들을 불러오는 로직을 만든다.
